...
const vcard = 'BEGIN:VCARD\n' // metadata of the contact card
            ...
            + 'FN:ZEUS\n' //NAMA LU
            + 'ORG:Owner Bot;\n' // NAMA CONTACT OWNER
            + 'TEL;type=CELL;type=VOICE;waid=5582991301316:+55 82 99130-1316\n' // NOMER OWNER
            + 'END:VCARD'
prefix = '#'//PREFIX BOT
blocked = ['5582991301316']//NOMER BLOCK
limitawal = '50'
cr = '*BOT WHATSAPP*'
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			const isOwner = ownerNumber.includes(sender)
                        ...
                        const NomerOwner = '5582991301316@s.whatsapp.net'//Nomer Owner
               ...
               if (data.error) return reply(data.error)
				...
				case 'tm':
					...
					if (isMedia && !mek.message.videoMessage || isQuotedImage) {
						...
						for (let _ of anu) {
							sendMess(_.jid, `*[ NAGATO BROADCAST ]*\n\n${body.slice(4)}`)
						}
